...
@WebServlet("/CustomerssAPI")
public class customerssAPI extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	
	Item customerObj = new Customer();
    /**
     * Default constructor. 
     */
    public CustomersAPI() {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			...
			String output =  customerObj.insertCustomer(request.getParameter("account_number"),
